...
# Carga de imágenes
gameover1 = pygame.transform.scale(pygame.image.load("img/gameover1.jpg"), (1000, 700))
...
def niveles1():
    ...
    while True:
        ...
        TEXTO_MENU = obtener_fuente(50).render("SUERTE A LA PROXIMA!!", True, "#DDFC42")
        RECTANGULO_TEXTO_MENU = TEXTO_MENU.get_rect(center=(500, 80))

        REINICIAR = Button(image=None, pos=(500, 620), text_input="REINICIAR", font=obtener_fuente(50), base_color="#5F9EA0", hovering_color="#DC143C")

...
IMG_NIVEL33 = pygame.transform.scale(pygame.image.load("img2/siguiente2.png"), (100, 80))
...
def winner_22():
    ...
    while True:
        ...
        NIVEL33 = Button(image=IMG_NIVEL33, pos=(500, 650))

        for boton in [BOTON_SALIR, NIVEL33]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if NIVEL33.checkForInput(MOUSE_POS):
                    from nivel33_español import nivel_33
                    nivel_33()

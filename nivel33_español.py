...
ENEMY_SPEED_RATE = 450
MEDICINE_SPAWN_RATE = 3000
...
icon = pygame.image.load("img2/viruscafe.png")
...
class Medicine(pygame.sprite.Sprite):
    def __init__(self, medicine_img):
        super().__init__()
        self.image = pygame.transform.scale(medicine_img, (50, 50))
...
def load_level_2_images():
    ...
    enemy_img = load_image('img2/viruscafe.png')
    medicine_img = load_image('img2/botiquin4.png')
...
def nivel33_español():
    ...
    while running:
        ...
        pygame.display.flip()
        if time_left <= 1:
            from winner33 import winner_33
            winner_33()
        elif player.health <= 0:
            from gameover33 import gameover_33
            gameover_33()
            running = False

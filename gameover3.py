...
IMG_NIVEL3 = pygame.transform.scale(pygame.image.load("img2/Reiniciar.png"), (100, 80))
...
def gameover_3():
    ...
    while True:
        ...
        NIVEL3 = Button(image=IMG_NIVEL3, pos=(490, 650))
        BOTON_SALIR = Button(image=IMG_SALIR, pos=(80, 50))

        for boton in [NIVEL3, BOTON_SALIR]:

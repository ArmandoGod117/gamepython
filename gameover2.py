...
IMG_NIVEL2 = pygame.transform.scale(pygame.image.load("img2/Reiniciar.png"), (100, 80))
...
def gameover_2():
    ...
    while True:
        ...
        NIVEL2 = Button(image=IMG_NIVEL2, pos=(490, 650))
        BOTON_SALIR = Button(image=IMG_SALIR, pos=(80, 50))

        for boton in [NIVEL2, BOTON_SALIR]:
